...
console.log(getSubscriptionPrice('professional')); // число 20
console.log(getSubscriptionPrice('organization')); // число 50
console.log(getSubscriptionPrice('starter')); // число 0
